...
def get_data(config_dict, blockid, dotw, crimeviolence, crimeppos, locgroups):
    ...
    funcs = {
        ...
        "crmvio": lambda res: crimevio.append({"count": res['count'], "id": res['violence']}),
        "crmppo": lambda res: crimeppo.append({"count": res['count'], "id": res['ppo']}),
        "locgroup": lambda res: locdesc.append({"count": res['count'], "id": res['locgroup']})
    }
